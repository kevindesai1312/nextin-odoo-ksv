...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50 flex items-center justify-center p-4">
      <div className="bg-white border border-slate-200 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-8 w-full max-w-2xl">
        {/* Logo */}
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <span className="font-nunito text-lg font-bold text-slate-900">
            VendorBridge
          </span>
        </div>

        {/* Photo upload section */}
        <div className="relative w-20 h-20 rounded-full border-2 border-dashed border-slate-300 flex items-center justify-center mx-auto mb-6 bg-gradient-to-br from-blue-50 to-teal-50 hover:border-teal-500 hover:bg-teal-50 transition-all duration-300 cursor-pointer group">
          <User size={32} className="text-slate-400 group-hover:text-teal-600 transition-colors duration-300" />
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                className="input-field focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <select
                className="input-field focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 cursor-pointer"
                value={form.role}
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="input-field focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 resize-vertical"
              rows={4}
